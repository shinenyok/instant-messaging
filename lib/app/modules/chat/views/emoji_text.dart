...
class EmojiText extends SpecialText {
  EmojiText(TextStyle? textStyle, {this.start = 0})
      : super(EmojiText.flag, ']',textStyle = TextStyle());
  ...
  InlineSpan finishText() {
    ...
    if (EmojiUitl.instance.emojiMap.containsKey(key) && !kIsWeb) {
      ...
      return ImageSpan(
          ...
          start: start,
          fit: BoxFit.fill,
          margin: const EdgeInsets.only(left:0, top: 2.0, right: 0));
    }
...
class EmojiUitl {
  ...
  final String _emojiFilePath = 'assets/emoji/sg';
